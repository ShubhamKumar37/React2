...
export default function ProductCard({ Post }) {
    ...
    return (
        <div className="rounded-lg border border-[#bdbdbd] flex flex-col justify-between p-2 hover:scale-105 hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] transition-all duration-200 cursor-pointer">
